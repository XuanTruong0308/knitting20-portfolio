    ...
    <section id="donate" className="py-20 relative bg-[#010a13] border-t border-[#c89b3c]/20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <motion.div 
          ...
          className="hextech-border p-6 sm:p-10 rounded-2xl shadow-hextech-gold bg-[#091428]/90 relative"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <motion.div 
              ...
              className="md:col-span-5 flex flex-col items-center justify-center p-6 bg-[#010a13] border border-[#c89b3c]/50 rounded-xl relative overflow-hidden group shadow-lg"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#ffd700]/10 rounded-full blur-2xl pointer-events-none" />
              
              <div className="relative p-2.5 bg-white rounded-lg shadow-2xl group-hover:scale-105 transition-transform duration-300">
                <img
                  src={qrUrl}
            ...
            >
              ...
              {/* Bank Name */}
              <motion.div variants={itemVariants} className="flex items-center justify-between p-3.5 bg-[#010a13] border border-[#c89b3c]/30 rounded-lg hover:border-[#00f0ff]/50 transition-colors">
              ...
              <motion.div variants={itemVariants} className="flex items-center justify-between p-3.5 bg-[#010a13] border border-[#ffd700]/50 rounded-lg shadow-hextech-gold">
                <div className="text-left">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded bg-[#ffd700] hover:bg-amber-400 text-black font-rajdhani font-bold text-xs flex items-center gap-1.5 transition-all shadow-md hover:scale-105"
                >
                  {copiedField === 'stk' ? (
                    <>
